...
const kpis = [
  { label: "Active sellers", value: platformKpis.activeSellers.toLocaleString(), icon: Users },
  { label: "Listings generated today", value: platformKpis.listingsToday.toLocaleString(), icon: Sparkles },
  { label: "Avg. inference latency", value: `${platformKpis.avgLatencyMs}ms`, icon: Activity },
  { label: "Drift alerts", value: platformKpis.driftAlerts, icon: AlertTriangle },
];
